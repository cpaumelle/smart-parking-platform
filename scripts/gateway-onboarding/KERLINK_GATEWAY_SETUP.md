...
This guide provides step-by-step instructions for configuring Kerlink LoRaWAN gateways to connect to the ChirpStack LoRaWAN Network Server hosted at `chirpstack.verdegris.eu`.
...
```json
{
  "gateway_conf": {
    ...
    "server_address": "parking-chirpstack (internal) or VPS public IP",
    "serv_port_up": 1700,
    "serv_port_down": 1700,
...
1. Navigate to: https://chirpstack.verdegris.eu
...
ping parking-chirpstack (internal) or VPS public IP

# Check if UDP 1700 is reachable
nc -u parking-chirpstack (internal) or VPS public IP 1700
```
...
# On ChirpStack server (Smart Parking Platform (VPS-819ab7a9))
...
```
Protocol: UDP
Destination: parking-chirpstack (internal) or VPS public IP
Port: 1700
Direction: Outbound
```
