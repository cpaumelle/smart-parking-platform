# Smart Parking Platform API Reference - v5.4
...
**Use Case:** Display available device types when provisioning new devices.
...
Get the computed display state for a space (debugging/monitoring).
